...
MainWindow::MainWindow(QWidget* parent)
    ...
    QObject::connect(m_gamepad.get(), SIGNAL(up()), this, SLOT(M_up()));
    QObject::connect(m_gamepad.get(), SIGNAL(down()), this, SLOT(M_down()));
    QObject::connect(m_gamepad.get(), SIGNAL(left()), this, SLOT(M_left()));
    QObject::connect(m_gamepad.get(), SIGNAL(right()), this, SLOT(M_right()));
    QObject::connect(m_gamepad.get(), SIGNAL(stop()), this, SLOT(M_stop()));
    QObject::connect(m_gamepad.get(), SIGNAL(takeOff()), this, SLOT(M_takeOff()));
    QObject::connect(m_gamepad.get(), SIGNAL(land()), this, SLOT(M_land()));
}
