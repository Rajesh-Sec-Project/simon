...
MainWindow::MainWindow(QWidget* parent)
    ...
    QObject::connect(&CommManager::self(), SIGNAL(packetReceived(lcomm::Endpoint&,lcomm::PacketBase)), this, SLOT(M_receivedLog(lcomm::Endpoint&,lcomm::PacketBase)));
}
...
void MainWindow::M_receivedLog(lcomm::Endpoint &, const lcomm::PacketBase &packet)
{
    ...
    m_ui->log->append(prefix + QString((log->message() + "\n").c_str()));
    // Restore
