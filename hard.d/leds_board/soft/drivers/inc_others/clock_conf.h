...
#define RCC_HPRE_VAL(pre)                                                                                                       \
    ((pre == 1) ? 0 : (7 + (pre > 256) + (pre > 128) + (pre > 64) + (pre > 16) + (pre > 8) + (pre > 4) + (pre > 2) + (pre > 1)) \
                          << RCC_HPRE_SHIFT)
...
#define IS_HSE_DIV_2 \
    5 /**< Indique l'utilisation de l'entrée HSE divisée par 2 (uniquement sur STM32F103 pour _PLLXTPRE) */
