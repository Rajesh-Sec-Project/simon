...
#define IS_I2S_AUDIO_FREQ(FREQ)                                                                         \
    (((FREQ) == I2S_AudioFreq_96k) || ((FREQ) == I2S_AudioFreq_48k) || ((FREQ) == I2S_AudioFreq_44k) || \
     ((FREQ) == I2S_AudioFreq_32k) || ((FREQ) == I2S_AudioFreq_22k) || ((FREQ) == I2S_AudioFreq_16k) || \
     ((FREQ) == I2S_AudioFreq_11k) || ((FREQ) == I2S_AudioFreq_8k) || ((FREQ) == I2S_AudioFreq_Default))
/**
  * @}
  */
...
#define IS_SPI_I2S_GET_FLAG(FLAG)                                                                                                \
    (((FLAG) == SPI_I2S_FLAG_BSY) || ((FLAG) == SPI_I2S_FLAG_OVR) || ((FLAG) == SPI_FLAG_MODF) || ((FLAG) == SPI_FLAG_CRCERR) || \
     ((FLAG) == I2S_FLAG_UDR) || ((FLAG) == I2S_FLAG_CHSIDE) || ((FLAG) == SPI_I2S_FLAG_TXE) || ((FLAG) == SPI_I2S_FLAG_RXNE))
/**
  * @}
  */
